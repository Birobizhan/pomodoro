...
class AuthService:
    ...
    async def get_yandex_auth(self, code: str) -> UserLoginSchema:
        """Метод регистрации через яндекс"""
    ...
    async def google_auth(self, code: str) -> UserLoginSchema:
        """Метод регистрации через google"""
    ...
    async def login(self, username: str, password: str) -> UserLoginSchema:
        """Метод авторизации по паролю и имени пользователя"""
